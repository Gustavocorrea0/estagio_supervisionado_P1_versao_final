 ...
 * @author Gustavo
 */
public class Milho extends Planta {
    private int idMilho;
    private Date dataDeSurgimentoDeEspigas;

    @Override
    public void setIdPropriedade(int idPropriedade) {
        super.setIdPropriedade(idPropriedade); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/OverriddenMethodBody
    }

    @Override
    public int getIdPropriedade() {
        return super.getIdPropriedade(); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/OverriddenMethodBody
    }

    public int getIdMilho() {
        return idMilho;
    }

    public void setIdMilho(int idMilho) {
        this.idMilho = idMilho;
    }

    public Date getDataDeSurgimentoDeEspigas() {
        return dataDeSurgimentoDeEspigas;
    }

    public void setDataDeSurgimentoDeEspigas(Date dataDeSurgimentoDeEspigas) {
        this.dataDeSurgimentoDeEspigas = dataDeSurgimentoDeEspigas;
    }
    ...
    public void setFornecedorPlanta(String fornecedorPlanta) {
        super.setFornecedorPlanta(fornecedorPlanta); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/OverriddenMethodBody
    }

    @Override
    public String getFornecedorPlanta() {
        return super.getFornecedorPlanta(); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/OverriddenMethodBody
    }
