...
public class TelaDeRemocaoSemente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextFieldMarcaSemente, new org.netbeans.lib.awtextra.AbsoluteConstraints(32, 389, 272, 30));
        ...
        getContentPane().add(jTextFieldQuantidadeEmSacos, new org.netbeans.lib.awtextra.AbsoluteConstraints(32, 563, 271, 30));
        ...
        getContentPane().add(jTextFieldIdSemente, new org.netbeans.lib.awtextra.AbsoluteConstraints(32, 116, 272, 30));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/telasDeEstoque/telasSemente/img_tela_remocao_semente.png"))); // NOI18N
    ...
    private void jButtonBuscarSementeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarSementeActionPerformed
        try {
            ...
            Logger.getLogger(TelaDeRemocaoSemente.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void removerSemente() {
        nomeInsumo = jTextFieldIdSemente.getText();
        msg = controleEstoque.removerSemente(nomeInsumo);
