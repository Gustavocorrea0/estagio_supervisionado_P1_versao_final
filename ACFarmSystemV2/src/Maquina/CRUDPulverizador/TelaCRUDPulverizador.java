...
public class TelaCRUDPulverizador extends javax.swing.JFrame {

    public TelaCRUDPulverizador() {
        initComponents();
        readPulverizador();
    }
    ...
    private void initComponents() {
        ...
        jTablePulverizador = new javax.swing.JTable();
        ...
        jTablePulverizador.setBackground(new java.awt.Color(15, 42, 61));
        jTablePulverizador.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jTablePulverizador.setForeground(new java.awt.Color(255, 255, 255));
        jTablePulverizador.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jTablePulverizador.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jTablePulverizador.setGridColor(new java.awt.Color(255, 204, 0));
        jTablePulverizador.setRowHeight(30);
        jTablePulverizador.setSelectionForeground(new java.awt.Color(15, 42, 61));
        jScrollPane1.setViewportView(jTablePulverizador);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 280, 890, 340));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/telasMaquinas/img_tela_CRUD_pulverizador.png"))); // NOI18N
    ...
    private void jButtonAdicionarMaquinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarMaquinaActionPerformed
        ...
        this.dispose();
        new TelaDeCadastroPulverizador().setVisible(true);
    ...
    private void jButtonAtualizarMaquinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAtualizarMaquinaActionPerformed
        ...
        this.dispose();
        new TelaDeAtualizacaoPulverizador().setVisible(true);
    ...
    private void jButtonRemoverMaquinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRemoverMaquinaActionPerformed
        ...
        this.dispose();
        new TelaDeRemocaoPulverizador().setVisible(true);
    ...
    private void jButtonVerificarMaquinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVerificarMaquinaActionPerformed
        ...
        this.dispose();
        new TelaDeConsultaPulverizador().setVisible(true);
    ...
    private void readPulverizador() {
        DefaultTableModel modelo = (DefaultTableModel) jTablePulverizador.getModel();
        ControleMaquina controleMaquina = new ControleMaquina();

        for (Pulverizador t : controleMaquina.readPulverizador()) {
            modelo.addRow(new Object[]{t.getNomeMaquina(), t.getMarcaMaquina(), t.getEstadoMaquina(), t.getAnoMaquina(), t.getIdPulverizador()});
        }
    }
    ...
    private javax.swing.JTable jTablePulverizador;
