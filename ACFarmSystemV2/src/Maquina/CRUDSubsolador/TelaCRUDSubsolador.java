...
public class TelaCRUDSubsolador extends javax.swing.JFrame {

    public TelaCRUDSubsolador() {
        initComponents();
        readPulverizador();
    }
    ...
    private void initComponents() {
        ...
        jTableSubsolador = new javax.swing.JTable();
        ...
        jTableSubsolador.setBackground(new java.awt.Color(15, 42, 61));
        jTableSubsolador.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jTableSubsolador.setForeground(new java.awt.Color(255, 255, 255));
        jTableSubsolador.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jTableSubsolador.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jTableSubsolador.setGridColor(new java.awt.Color(255, 204, 0));
        jTableSubsolador.setRowHeight(30);
        jTableSubsolador.setSelectionForeground(new java.awt.Color(15, 42, 61));
        jScrollPane1.setViewportView(jTableSubsolador);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 280, 890, 340));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/telasMaquinas/img_tela_CRUD_subsolador.png"))); // NOI18N
    ...
    private void jButtonAdicionarMaquinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarMaquinaActionPerformed
        this.dispose();
        new TelaDeCadastroSubsolador().setVisible(true);
    ...
    private void jButtonAtualizarMaquinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAtualizarMaquinaActionPerformed
        this.dispose();
        new TelaDeAtualizacaoSubsolador().setVisible(true);
    ...
    private void jButtonRemoverMaquinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRemoverMaquinaActionPerformed
        this.dispose();
        new TelaDeRemocaoSubsolador().setVisible(true);
    ...
    private void jButtonVerificarMaquinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVerificarMaquinaActionPerformed
        this.dispose();
        new TelaDeConsultaSubsolador().setVisible(true);
    ...
    private void readPulverizador() {
        DefaultTableModel modelo = (DefaultTableModel) jTableSubsolador.getModel();
        ControleMaquina controleMaquina = new ControleMaquina();

        for (Subsolador t : controleMaquina.readSubsolador()) {
            modelo.addRow(new Object[]{t.getNomeMaquina(), t.getMarcaMaquina(), t.getEstadoMaquina(), t.getAnoMaquina(), t.getIdSubsolador()});
        }
    }
    ...
    private javax.swing.JTable jTableSubsolador;
