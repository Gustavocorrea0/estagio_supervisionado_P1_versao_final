...
public class TelaDeCadastroColheitadeira extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jRadioCulturaSoja, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 340, 120, 20));
        ...
        getContentPane().add(jRadioCulturaMilho, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 310, 120, 20));
    ...
    public void cadastrarColheitadeira() {
        ...
        if (buttonGroupEstado.equals(jRadioEstadoAtivo) && buttonGroupEstado.equals(jRadioEstadoInativo)) {
            JOptionPane.showMessageDialog(null, "Escolha apenas um estado");
            return;
        }
